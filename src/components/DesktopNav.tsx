import {CameraIcon, HomeIcon, LayoutGridIcon, SearchIcon, UserIcon, LogOutIcon} from "lucide-react";
    ...
    <nav className="hidden lg:block w-64 border-r border-border bg-card/50 backdrop-blur-sm">
      <div className="sticky top-0 h-screen flex flex-col">
        ...
        <div className="p-6 border-b border-border">
          <Link href="/" className="flex items-center space-x-2 hover-lift-sm">
            <div className="w-8 h-8 ig-gradient rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg">I</span>
            </div>
            <span className="text-xl font-bold ig-gradient-text font-serif">Infocus</span>
          </Link>
        </div>
